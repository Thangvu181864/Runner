import { Scene, DirectionalLight, AmbientLight, Object3D, AnimationMixer, AnimationAction, Clock, Box3, BoxGeometry, MeshPhongMaterial, Mesh, Vector3, Group } from "three";
